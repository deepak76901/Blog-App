...
export default function PostCard({ post }) {
  return (
    <div className="group relative max-w-[350px] overflow-hidden h-[330px] transition-all border border-teal-400 rounded-lg hover:border-2">
      <Link to={`/post/${post.slug}`}>
        <img
          src={post.image}
          alt={post.title}
          className="h-[200px] w-[320px] object-cover  group-hover:h-[175px] transition-all duration-300 z-20"
        />
